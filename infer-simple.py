...
def sum_condition(detection_count):
    global cumulative_sum
    cumulative_sum += 10 * detection_count
...
def infer():
    ...
    if 'predictions' in result:
        ...
        sum_condition(detection_count)  # Call the sum_condition function with the number of detections
